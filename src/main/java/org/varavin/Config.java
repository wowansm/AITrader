...
public class Config {
    ...
    public static final int CNN_N_FILTERS = 80;
    ...
    public static final double ATR_STOP_MULTIPLIER = 5.0;

    public static final double FIXED_RISK_REWARD_RATIO = 1.5;
    public static final double SIGNAL_THRESHOLD = 1.5;
}
